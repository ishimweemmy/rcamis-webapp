...
<div class="flex flex-col w-full gap-5 text-white bg-black">
    ...
    <div class="grid w-full gap-4 xl:grid-cols-6 md:grid-cols-5 sm:grid-cols-4">
        <a href="listcourse.php" class="flex flex-col gap-2 rounded-md duration-300 hover:text-black shadow-md border-[1px] hover:scale-110 hover:bg-slate-200 p-4 items-center">
            <i class="bx bx-book-open text-3xl text-violet-800"></i>
            <p>56 courses</p>
            <h1 class="text-lg font-semibold">View Courses</h1>
        </a>
        <a href="listuser.php" class="flex flex-col gap-2 rounded-md duration-300 hover:text-black shadow-md border-[1px] hover:scale-110 hover:bg-slate-200 p-4 items-center">
            <i class="bx bx-user text-3xl text-violet-800"></i>
            <p>60 users</p>
            <h1 class="text-lg font-semibold">View Users</h1>
        </a>
        <a href="students.php?page='marks'?action='list'" class="flex flex-col gap-2 rounded-md duration-300 hover:text-black shadow-md border-[1px] hover:scale-110 hover:bg-slate-200 p-4 items-center">
            <i class="bx bx-user text-3xl text-violet-800"></i>
                <p><%= number%></p>
            <h1 class="text-lg font-semibold">View Students</h1>
        </a>
        <a href="instructors.php" class="flex flex-col gap-2 rounded-md duration-300 hover:text-black shadow-md border-[1px] hover:scale-110 hover:bg-slate-200 p-4 items-center">
            <i class="bx bx-user text-3xl text-violet-800"></i>
            <p>60 instructors</p>
            <h1 class="text-lg font-semibold">View Instructors</h1>
        </a>
        <a href="employees.php" class="flex flex-col gap-2 rounded-md duration-300 hover:text-black shadow-md border-[1px] hover:scale-110 hover:bg-slate-200 p-4 items-center">
            <i class="bx bx-user text-3xl text-violet-800"></i>
            <p>32 employees</p>
            <h1 class="text-lg font-semibold">View Employees</h1>
        </a>
        <a href="managers.php" class="flex flex-col gap-2 rounded-md duration-300 hover:text-black shadow-md border-[1px] hover:scale-110 hover:bg-slate-200 p-4 items-center">
            <i class="bx bx-user text-3xl text-violet-800"></i>
            <p>${employees}</p>
