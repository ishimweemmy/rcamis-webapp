<div class=" w-[250px] border-r-[1px] text-white md:flex justify-between hidden flex-col p-4 py-9 bg-primary fixed top-0 left-0 h-screen">
    ...
    <div class="flex flex-col gap-y-3 w-full text-white">
        <a
                href="/"
                class="flex items-center rounded-md py-2 px-3 hover:bg-blue-500/30 hover:text-blue-500 duration-200"
        >
